...
stdenv.mkDerivation rec {
  ...
  '' + lib.strings.optionalString withElectron ''
    mkdir $out/opt/Discord/resources/unpackaged
    asar e $out/opt/Discord/resources/app.asar $out/opt/Discord/resources/unpackaged/app
    rm $out/opt/Discord/resources/app.asar
    #sed -i "s|process.resourcesPath|'${pkgs.electron_23}'|" $out/opt/Discord/resources/unpackaged/app/app_bootstrap/buildInfo.js
    #sed -i "s|\"electron\": \"22\.3\.12\"|\"electron\": \"23.3.13\"|g" $out/opt/Discord/resources/unpackaged/app/package.json 
    sed -i 's|https://discord\.com/api|https://spacebar.chat|g' $out/opt/Discord/resources/unpackaged/app/app_bootstrap/Constants.js 
    asar p $out/opt/Discord/resources/unpackaged $out/opt/Discord/resources/app.asar
    rm -rf $out/opt/Discord/resources/unpackaged
  '';
